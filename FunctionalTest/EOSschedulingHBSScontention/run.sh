#NOTE: diffs may fail due to floating point inaccuracties.  The test still passes.
echo "testing EOSschedulingHBSScontention"
rm -rf runDirectory
mkdir runDirectory
cd runDirectory
...
echo "contentionStatistics.tsd"
diff runDirectory/contentionStatistics.tsd correctDirectory/contentionStatistics.tsd
