...
private void setParameters() {
    ...
    scheduler = new gov.nasa.javaGenes.EOSscheduling.HBSS.contention.Scheduler(model,2,3,4,5);
    ((gov.nasa.javaGenes.EOSscheduling.HBSS.contention.Scheduler)scheduler).printContentionStatistics("contentionStatistics.tsd");
    ...
    evaluationFunction = new MinimizeSlewingFitness(scheduler,model);
